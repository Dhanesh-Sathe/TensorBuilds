...
const Register = () => {
  ...
  // }
  return (
    <div className="bgcolor bg-cover flex justify-center items-center h-screen">
          ...
          <div className="md:w-1/2 p-4">
            ...
            <form className="space-y-4">
              ...
              <input
                ...
                className="w-full p-2 border rounded text-black"
              />
              <button onClick={register} type="submit" className="bg-purple-600 font-semibold w-full py-2 rounded text-white">
                Sign Up
              </button>
